"""
Django settings for fbpj project.
...
SECRET_KEY = 'django-insecure-qx!(gvc803m=sybcs21d%oj2erd5(h)9vfi7ds$(30n1n(yj&*'
...
WSGI_APPLICATION = 'fbpj.wsgi.application'
